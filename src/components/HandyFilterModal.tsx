...
const minHourlyRates = [20, 30, 40, 50];
const locations = ['Leuven', 'Brussel', 'Antwerpen', 'Gent', 'Mechelen', 'Brugge'];
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="flex flex-wrap gap-2">
              {filteredLocations.map((location) => (
                <Badge
                  key={location}
                  variant="outline"
                  className="cursor-pointer py-2 px-4 hover:bg-primary/10"
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Stel je gewenste minimum uurtarief in
            </p>
            
            <div className="flex gap-2">
              {minHourlyRates.map((rate) => (
                <button
                  key={rate}
          ...
          <div className="flex items-center justify-between p-4 bg-background rounded-2xl">
            <div>
              <h3 className="font-semibold text-foreground">Alleen geverifieerde klanten</h3>
              <p className="text-muted-foreground text-sm">Klanten met betalingsverificatie</p>
            </div>
            <Switch
