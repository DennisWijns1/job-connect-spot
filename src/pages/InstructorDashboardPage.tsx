    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="w-full grid grid-cols-5 h-auto p-1 bg-secondary rounded-2xl mb-6">
            <TabsTrigger value="overview" className="flex flex-col items-center gap-1 py-3 rounded-xl data-[state=active]:bg-card">
              <LayoutDashboard className="w-4 h-4" />
              <span className="text-xs">Overzicht</span>
            </TabsTrigger>
            <TabsTrigger value="lessons" className="flex flex-col items-center gap-1 py-3 rounded-xl data-[state=active]:bg-card">
              <BookOpen className="w-4 h-4" />
              <span className="text-xs">Lessen</span>
            </TabsTrigger>
            <TabsTrigger value="enrollments" className="flex flex-col items-center gap-1 py-3 rounded-xl data-[state=active]:bg-card">
              <Users className="w-4 h-4" />
              <span className="text-xs">Deelnemers</span>
            </TabsTrigger>
            <TabsTrigger value="reviews" className="flex flex-col items-center gap-1 py-3 rounded-xl data-[state=active]:bg-card">
              <Star className="w-4 h-4" />
              <span className="text-xs">Reviews</span>
            </TabsTrigger>
            <TabsTrigger value="profile" className="flex flex-col items-center gap-1 py-3 rounded-xl data-[state=active]:bg-card">
